              ...
              <div class="tab-pane active" id="basic">
                    ...
                    <div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="tender_reference" name="t" placeholder="Tender Reference Number">
                        </div>
                      </div>
                        ...
                        <!-- form start -->
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                              <input type="text" value="" id="datetimepicker" name="pub_time" style="width:240px" placeholder="Enter date and type">
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                              <input type="text" value="" id="datetimepicker1" name="doc_time" style="width:240px" placeholder="Enter date and type">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                              <input type="text" value="" id="datetimepicker2" name="bid_start_time" style="width:240px" placeholder="Enter date and type">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                              <input type="text" value="" id="datetimepicker3" name="bid_close_time" style="width:240px" placeholder="Enter date and type">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                              <input type="text" value="" id="datetimepicker4" name="bid_open_time" style="width:240px" placeholder="Enter date and type">
                              </div>
                            </div>
                          ...
                          <input type="submit" value="Submit" name="submit" onclick="submitForms()" />
