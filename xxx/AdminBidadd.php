...
$sql=mysqli_query($db,"SELECT * FROM openbid WHERE Bid_Id='$Bid_Id'");
    if(mysqli_num_rows($sql)>0){
        ...
        if(mysqli_query($db,"INSERT INTO openbid (Bid_Id,Bid_Name) values('$Bid_Id','$Bid_Name')")){
...
<head>
  ...
  <title>E-Proc UCSC | Add Open Bid</title>
