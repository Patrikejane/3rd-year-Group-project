...
$sql=mysqli_query($db,"SELECT * FROM impending_bid WHERE Bid_Id='$Bid_Id'");
    if(mysqli_num_rows($sql)>0){
        ...
        if(mysqli_query($db,"INSERT INTO impending_bid (Bid_Id,Bid_Name) values('$Bid_Id','$Bid_Name')")){
...
<head>
  ...
  <title>E-Proc UCSC | Add Impending Bid</title>
