...
if(isset($_POST['submit'])){
    $sql="update impending_bid set Bid_Id='".$_POST['Bid_Id']."',Bid_Name='".$_POST['Bid_Name']."' where Row_Id='".$_POST['Row_Id']."'";
...
if(isset($_GET['id'])){
    ...
    $result=mysqli_query($db,"select Row_Id,Bid_Id,Bid_Name from impending_bid where Row_Id=".$_GET['id']);
...
<head>
  ...
  <title>E-Proc UCSC | Admin Edit Impending Bid</title>
